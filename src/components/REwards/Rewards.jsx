        ...
        <>
            ...
            <Box sx={{ backgroundColor: 'black', color: 'white', width:"100vw" }}>
                <Container  sx={{display:"flex"}}>
                    <Stack   py={7}  alignItems="flex-start" spacing={2}>
                        ...
                        Refer CLAMIO to fellow creators or sell 100 Digital Products through CLAMIO, &
                        <br/>
                    ...
                    <Stack >
                         ...
                         <img src={img} alt="img" style={{ width: "320px", height: "370", position: "relative", top: "20px", left: "300px" }} />
...
<Stack display="flex" flexDirection="row" justifyContent="space-around" spacing={0} mt={10}>

{data.map((item)=>(
<Box sx={{height:"200px",width:"200px", background:"#FFDB58",borderRadius:"50%", padding:"15px"}} >
...
On every successful referral you will earn 500 CLAMIO Reward Coins.
<br/>
Every 100 coin = Rs. 1
</Typography>
<stack>
...
<Typography variant="body2" sx={{fontFamily:"unset",textAlign: 'left'}}>
On every successful sale of 100 Product you will earn 10,000 
<br/>CLAMIO Reward Coins.
<br/>
Every 100 coin = Rs. 1
</Typography>
...
{data2.map((item)=>(
<Box sx={{height:"200px",width:"200px",borderRadius:"50%", padding:"100px"}} >

<img src={item.img} style={{ width:"100%",height:"100%" }} alt="Key" />
